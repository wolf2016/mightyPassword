...
describe('Password Strength Check for admin users', () => {
  ...
  it('should show password123 is weak and why', () => {
    ...
    expect(PasswordPage.feedback).toHaveText('The password entered is not acceptable' +
      ' because it does not contain at least 3 special characters and it is not the minimum length');
  ...
  it('should show password1234! is weak and why', () => {
    PasswordPage.open();
    ...
    //verify the feedback is correctly displayed
    expect(PasswordPage.feedback).toHaveText('The password entered is not acceptable' +
      ' because it does not contain at least 3 special characters');
    expect(PasswordPage.feedbackContainer).not.toHaveElementClass('strong-pw');
    expect(PasswordPage.feedbackContainer).toHaveElementClass('weak-pw');
  });
  it('should show & is weak and why', () => {
    ...
    expect(PasswordPage.feedback).toHaveText('The password entered is not acceptable' +
      ...
      ' it does not contain at least 3 special characters, it is not the minimum length');
    expect(PasswordPage.feedbackContainer).not.toHaveElementClass('strong-pw');
    expect(PasswordPage.feedbackContainer).toHaveElementClass('weak-pw');
  });
  it('should show abcdefghijklm is weak and why', () => {
    ...
    //verify the feedback is correctly displayed
    expect(PasswordPage.feedback).toHaveText('The password entered is not acceptable' +
      ' because it does not contain any numbers and it does not contain at least 3 special characters');
    expect(PasswordPage.feedbackContainer).not.toHaveElementClass('strong-pw');
    expect(PasswordPage.feedbackContainer).toHaveElementClass('weak-pw');
  });
  it('should show &^@#&^!@&#^@!# is weak and why', () => {
    ...
    //verify the feedback is correctly displayed
    expect(PasswordPage.feedback).toHaveText('The password entered is not acceptable' +
      ' because it does not contain any numbers and it does not contain any letters');
    expect(PasswordPage.feedbackContainer).not.toHaveElementClass('strong-pw');
    expect(PasswordPage.feedbackContainer).toHaveElementClass('weak-pw');
  });
});